...
const ActionCard = ({ label, icon, color }) => {
  ...
  return (
    <motion.button
      ...
      className="p-5 rounded-2xl flex flex-col items-center gap-4 cursor-pointer text-center group w-full"
    ...
    >
      ...
      <div>
        ...
        <span className="text-[10px] uppercase font-bold" style={{ color: '#60A5FA' }}>QUICK ACTION</span>
      </div>
    </motion.button>
  );
};
